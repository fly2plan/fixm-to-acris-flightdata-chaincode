export const Model = JSON.stringify({
  ...
  AircraftTransportEquipment: {
    CommunicationCapabilityCode: [
      ...
      "fx:capabilities",
      "fx:communication",
      "fx:communicationCapabilityCode",
    ],
    datalinkCommunicationCapabilityCodeList: [
      "fx:Flight",
      "fx:aircraft",
      "fx:capabilities",
      "fx:communication",
      "fx:datalinkCommunicationCapabilityCode",
    ],
    dinghies: "DinDinghy",
    emergencyRadioCapabilityTypeList: [
      "fx:Flight",
      "fx:aircraft",
      "fx:capabilities",
      "fx:survival",
      "fx:emergencyRadioCapabilityType",
    ],
    ...
    otherNavigationCapabilities: [
      ...
      "fx:capabilities",
      "fx:navigation",
      "fx:otherNavigationCapabilities",
    ],
