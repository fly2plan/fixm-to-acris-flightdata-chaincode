export const Model = JSON.stringify({
  ...
  arrivalAirportSlotIdentification: [
    "fx:Flight",
    "fx:departure",
    "fx:airportSlotIdentification",
  ],
  cruiseClimbLevel: [
    "fx:Flight",
    "fx:routeTrajectoryGroup",
  ...
  departureAirportSlotIdentification: [
    "fx:Flight",
    "fx:departure",
    "fx:airportSlotIdentification",
  ],
  ...
  destinationAirportPrevious: [
    "fx:Flight",
    "fx:arrival",
    "fx:destinationAerodromePrevious",
    "iataDesignator",
  ],
  estimatedAircraftTakeoffMass: [
    "fx:Flight",
    "fx:routeTrajectoryGroup",
    "fx:agreed",
    "fx:takeoffMass",
  ...
  inboundOriginPrevious: [
    "fx:Flight",
    "fx:departure",
    "fx:aerodromePrevious",
    "locationIndicator",
  ],
  operator: ["fx:Flight", "fx:operator", "operatingOrganization"],
  personsOnBoardQuantity: [
    "fx:Flight",
    "fx:supplementaryData",
    "fx:personsOnBoard",
  ],
  ...
  runwayLandingDirection: [
    "fx:Flight",
    "fx:arrival",
    "fx:runwayDirection",
    "_",
  ],
  runwayTakeoffDirection: [
    "fx:Flight",
    "fx:departure",
    "fx:runwayDirection",
    "_",
  ],
  speedScheduleInitialSpeed: [
    "fx:Flight",
    "fx:routeTrajectoryGroup",
    "fx:agreed",
    "fx:climbSchedule",
